...
### -- Constants -- ###
ORIG.DATA.FILE <- "CA_Inputs_HWP_Model.xlsx"    # Original data file
NEW.DATA.FILE <- "CA_MBF_2019.xlsx"            # Excel file with harvest data (must be Excel, not CSV)
OUT.DATA.FILE <- "CAn_Inputs_HWP_Modelv2.xlsx"  # The output file name
